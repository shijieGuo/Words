...
import com.example.guoshijie.words.getwordsFromMysql.getwordsFromMysql;
import com.example.guoshijie.words.myAdapter.myAdapter;
...
public void setView(){
        ...
        adapter=new myAdapter(getActivity(),R.layout.item,words);
